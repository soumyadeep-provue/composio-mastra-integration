...
The tools are loaded and ready - they just need Gmail authentication to access user data.`;
  ...
  tools: async ({ runtimeContext }) => {
    ...
    const url = connectedAccountId
      ? `https://mcp.composio.dev/composio/server/f24ad626-4f7b-4f3f-9ea9-65509cee10ee/mcp?connected_account_id=${connectedAccountId}`
      : 'https://mcp.composio.dev/composio/server/f24ad626-4f7b-4f3f-9ea9-65509cee10ee/mcp';
